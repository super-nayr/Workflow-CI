...
def load_data(data_path):
    ...
    target_column = "LUNG_CANCER" # Pastikan nama kolom target benar
    if target_column not in df.columns:
        print(f"::error::Kolom target '{target_column}' tidak ditemukan.")
        exit(1)

    # Mengubah target menjadi numerik jika formatnya YES/NO
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", default="survey_lung_cancer_clean.csv")
